...
import { Eye, EyeOff, ShoppingCart, CheckCircle, Layers, Shield, Zap, Users, ArrowRight, Sparkles, AlertCircle } from "lucide-react"
import { Badge } from "@/components/ui/badge"
import { useAppDispatch, useAppSelector } from "@/lib/store/hooks"
import { signIn, signUp, clearError } from "@/lib/store/slices/authSlice"
    ...
    try {
      if (activeTab === "signin") {
        ...
        if (signIn.fulfilled.match(result)) {
          ...
          setLocalError(typeof result.payload === 'string' ? result.payload : "Sign in failed")
        }
      } else {
        ...
        if (signUp.fulfilled.match(result)) {
          ...
          setLocalError(typeof result.payload === 'string' ? result.payload : "Sign up failed")
        }
      }
    } catch (err) {
