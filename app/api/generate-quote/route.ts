...
import { CostBreakdown, PrintSettings, FileAnalysis, Quote } from '@/lib/types'
  ...
  try {
    ...
    return NextResponse.json({
      ...
      quote: {
        ...
        settings: savedQuote.settings,
        costBreakdown: savedQuote.cost_breakdown,
        total_cost: savedQuote.total_cost,
        estimatedDays: savedQuote.estimated_days,
        validUntil: savedQuote.valid_until,
...
function generateQuoteNumber(): string {
  ...
  return `Q${dateString}-${randomString}`
}
